...
func rex_party():
	...
	var l = woody.instantiate()
	var m = jessie.instantiate()
	var n = bullseye.instantiate()
	add_child(i)
	add_child(j)
	add_child(k)
	add_child(l)
	...
	l.global_position = Vector3(-20,-4,-16)
	m.global_position = Vector3(-20,2,-10)
	m.rotate_y(PI)
	n.global_position = Vector3(randf_range(-10,10),-2,-10)
